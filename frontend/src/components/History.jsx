...
function History() {
  ...
  const industries = [
    ...new Set(history.map((h) => h.industry).filter(Boolean)),
  ];
                ...
                return (
                  <>
                    <tr
                      ...
                      style={{
                        cursor: "pointer",
                        background: isExpanded ? "#FFF7F5" : "var(--bg-white)",
                      }}
                    >
                      <td style={{ fontWeight: 600, color: "#E8510A" }}>
                        {item.job_title}
                      </td>
                      <td>
                        {item.industry ? (
                    ...
                    {isExpanded && (
                      <tr key={`expand-${item.id}`}>
                        <td
                          colSpan={5}
                          style={{ padding: 0, background: "#FFF7F5" }}
                        >
                          <div
                            style={{
                              padding: "20px",
                              borderTop: "1px solid #FDDECE",
                            }}
                          >
