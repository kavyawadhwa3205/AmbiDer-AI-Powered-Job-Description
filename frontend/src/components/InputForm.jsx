    ...
    recognition.onresult = (event) => {
      ...
      setFormData((prev) => ({
        ...
        additional_info: prev.additional_info
          ? prev.additional_info + " " + transcript
          : transcript,
      }));
    };
    ...
    <div className="input-form-page">
      <div className="form-area">
        <div className="page-header">
          ...
          <p>
            Fill in the details below and let AI generate a professional job
            description for you.
          </p>
        </div>
            ...
            <div className="title-row">
              ...
              <button
                ...
                style={{
                  ...
                  borderColor: isListening ? "#FECACA" : "",
                }}
              >
                <Mic
            ...
            <div className="form-group">
              ...
              >
                ...
                <option value="On-site">
                  On-site (Work from office full time)
                </option>
                <option value="Remote">
        ...
        <div className="suggestion-card">
          ...
          <div className="tips-list">
            <div className="tip-item">
              ...
              <span>Be specific about the role and requirements</span>
            </div>
            <div className="tip-item">
              <CheckCircle2 className="tip-icon" />
              <span>Add must-have skills and experience</span>
            </div>
            <div className="tip-item">
              <CheckCircle2 className="tip-icon" />
              <span>Include company and job location</span>
            </div>
            <div className="tip-item">
              <CheckCircle2 className="tip-icon" />
              <span>More details = better AI output</span>
            </div>
          </div>
        </div>
      </div>
